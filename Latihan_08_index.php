...
<head>
    ...
    <style>
        ...
        .jumbotron-bg{
            background-image: url('fkom.jpg');/*URL gambar latang belakang*/
            ...
            <main class="col-md-10">
                <article>
                    <?php
                        ...
                        if(isset($menu)){
                            if($menu == "a"){
                                include "Latihan_08.a.php";
                            }elseif($menu == "b"){
                                include "Latihan_08.b.php";
                            }elseif($menu == "c"){
                                include "Latihan_08.c.php";
                            }elseif($menu == "d"){
                                include "Latihan_08.d.php";
                            }
                        }else{
